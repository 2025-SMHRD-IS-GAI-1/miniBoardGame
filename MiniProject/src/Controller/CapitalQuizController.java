...
import Model.CapitalDAO;
import Model.CapitalQuizVO;
import View.CapitalQuizView;

public class CapitalQuizController implements MiniGameController{

    private final CapitalDAO dao = new CapitalDAO();
    private final CapitalQuizView view = new CapitalQuizView(); // ★ View 사용

    public CapitalQuizController(CapitalQuizView quizView, CapitalDAO capitalDAO) {
    ...
    public boolean gameStart() {
        ...
        CapitalQuizVO quiz = dao.randomQuiz(); // 랜덤 문제 (DAO)
        if (quiz == null) {
            view.showNoQuestion();
            return false;
        }
